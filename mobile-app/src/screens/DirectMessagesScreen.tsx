...
export function DirectMessagesScreen({ navigation, route }: Props) {
  ...
  const peerRows = [
    ...convs.map((it) => ({
      ...
      preview: messagePreview(it.last_message_preview || it.last_message?.body),
...
const styles = StyleSheet.create({
  ...
  convRow: { flexDirection: "row", alignItems: "center", gap: 10, paddingVertical: 11, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: "rgba(255,255,255,0.08)" },
  ...
  meta: { color: colors.textMuted, fontSize: 10, marginTop: 4, textAlign: "right" },
